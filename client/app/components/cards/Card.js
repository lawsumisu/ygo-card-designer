    ...
    if (this.props.cardState.monsterType === MonsterTypes.LINK) {
      return (
        <div className="card--battle-points--link-rating">
          <span>LINK-</span>
          <span
            className="card--battle-points--link-rating-value">{_.filter(this.props.cardState.linkArrows, (linkArrow) => linkArrow).length}</span>
        </div>
      );
    }
    else {
      return (
        <div>
          ...
          <input type="text" value={this.props.cardState.def}
        ...
        <div className="ygo-card-bottom">
          ...
          <div className="ygo-card-battle-points">
            <div>
              ...
              <input type="text" value={this.props.cardState.atk}
    ...
    return (
      <div className="card--container">
        <div className="card--settings--container">
          ...
          <CardDownloader
            cardName={this.props.cardState.name}
